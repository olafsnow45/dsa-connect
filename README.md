...
# DSA Connect [![Build status](https://github.com/Doughdapp/dsa-connect/actions/workflows/build.yml/badge.svg?branch=master&event=push)](https://github.com/Doughdapp/dsa-connect/actions/workflows/build.yml)

<img src="https://raw.githubusercontent.com/DoughDApp/dsa-connect/master/src/data/img.svg">
...
You can see the list of connectors [here](src/addresses) & [here](https://github.com/DoughDApp/dsa-connectors-new/blob/main/README.md)
